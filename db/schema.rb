...
ActiveRecord::Schema[7.0].define(version: 2023_06_30_100445) do
  ...
  create_table "hero_superpowers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hero_id"], name: "index_hero_superpowers_on_hero_id"
    t.index ["superpower_id"], name: "index_hero_superpowers_on_superpower_id"
  end
  ...
  add_foreign_key "hero_superpowers", "heros"
  add_foreign_key "hero_superpowers", "superpowers"
end
